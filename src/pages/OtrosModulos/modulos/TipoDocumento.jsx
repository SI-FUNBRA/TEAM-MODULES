...
const TipoDocumento = () => {
    ...
    //Eliminar
    const changeState = () => {
        servicioTipoDoc.deleteTipoDoc(Item.idTipoDoc).then(res=>{
            if(res.status===200){
    ...
    const formik = useFormik({
        ...
        onSubmit: (data) => {
            if (data.idTipoDoc) {
                ...
                servicioTipoDoc.updateTipoDoc(data, data.idTipoDoc).then(()=>{
                    //anuncio de exito :D
    ...
    return (
        ...
        <div className="grid crud-demo">
            ...
            <div className="col-12">
                ...
                <Dialog visible={updateDialog} style={{ width: '450px' }} modal header={(!formik.values.idTipoDoc)?"Nuevo Tipo Documento":`Editando a ${formik.values.nombreTipoDoc}` } className="card p-fluid" footer={productDialogFooter} onHide={hideDialog}>
